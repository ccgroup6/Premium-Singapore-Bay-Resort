...
<div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $form_classes ) ) ); ?>">
	<div class="apb-shortcode-check-room-js">
		<form id="apb-check-avb-form" method="GET" class="apb-check-avb-form" action="<?php echo esc_attr( apply_filters( 'abrs_search_form_action', $action ) ); ?>">
				...
				<div class="apb-content text-center clearfix">
					...
					<div class="apb-field apb-field--departure">
						...
						<div class="apb-field-group searchbox__box--checkout">
							<i class="apbf apbf-select"></i>
							<input type="text" data-bind="value: checkOutFormatted('<?php echo esc_attr( $date_format ); ?>')" class="searchbox__input-display awebooking-datepicker awebooking-input awebooking-end-date apb-input apb-calendar" placeholder="<?php esc_attr_e( 'Departure Date', 'fleurdesel' ); ?>">
