 ...
 *
 * This source code is taken from WPTRT/code-examples, the original source is
 * distributed through GNU v2 license, we not change any code except functions prefix.
 *
 ...
 */
function fleurdesel_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function fleurdesel_sanitize_css( $css ) {
 ...
 */
function fleurdesel_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function fleurdesel_sanitize_email( $email, $setting ) {
 ...
 */
function fleurdesel_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function fleurdesel_sanitize_html( $html ) {
 ...
 */
function fleurdesel_sanitize_image( $image, $setting ) {
 ...
 */
function fleurdesel_sanitize_nohtml( $nohtml ) {
 ...
 */
function fleurdesel_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function fleurdesel_sanitize_number_range( $number, $setting ) {
 ...
 */
function fleurdesel_sanitize_select( $input, $setting ) {
 ...
 */
function fleurdesel_sanitize_url( $url ) {
	return esc_url_raw( $url );
}

/**
 * String sanitization callback.
 *
 ...
 * @return string
 */
function fleurdesel_sanitize_value( $string ) {
